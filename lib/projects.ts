...
const projects: Project[] = [
  { title: "Signals", slug: "signals", summary: "An observability workspace that turns production events into actionable decisions.", published: true, featured: true, categories: ["Backend", "Cloud"], technologies: ["TypeScript", "PostgreSQL", "OpenTelemetry"], role: "Technical lead", repositoryUrl: "https://github.com/your-handle/signals" },
  ...
  { title: "Relay", slug: "relay", summary: "A reliable job orchestration service for event-driven workflows.", published: true, featured: true, categories: ["Backend", "Cloud"], technologies: ["Node.js", "Redis", "AWS"], role: "System designer", repositoryUrl: "https://github.com/your-handle/relay" }
];
